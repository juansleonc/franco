...
RSpec.describe 'V1::Contracts CRUD', type: :request do
  ...
  it 'creates, shows, updates and deletes contract' do
    post '/v1/contracts', params: { contract: { property_id: property.id, tenant_id: tenant.id, start_on: '2025-01-01', end_on: '2025-12-31', due_day: 5, monthly_rent: 1000 } }, headers: auth_headers, as: :json
    ...
    patch "/v1/contracts/#{c['id']}", params: { contract: { monthly_rent: 1200 } }, headers: auth_headers, as: :json
    expect(response).to have_http_status(:ok)
