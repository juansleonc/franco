...
RSpec.describe 'V1::Invoicing', type: :request do
  ...
  it 'generates monthly invoices idempotently' do
    ...
    first = JSON.parse(response.body)['generated']
    post '/v1/invoicing/generate_monthly', params: { as_of: '2025-08-20' }, headers: auth_headers
    second = JSON.parse(response.body)['generated']
